...
const EditEquipmentForm = ({ equipment, onClose }) => {
  const { updateEquipment, isLoading, getAllEquipment } = useEquipmentStore();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const success = await updateEquipment(equipment._id, {
      ...form,
